...
//    }
    ...
    public void writePersistance(String path, String content)throws Exception{
        ...
        curator.create().creatingParentsIfNeeded()
                .withMode(CreateMode.PERSISTENT).withACL(ZooDefs.Ids.OPEN_ACL_UNSAFE).forPath(builder.toString(), content.getBytes("utf-8"));
    }
    public void write(String path, String content) throws Exception {
        ...
        curator.create().creatingParentsIfNeeded()
                ...
                withACL(ZooDefs.Ids.OPEN_ACL_UNSAFE).forPath(builder.toString(), content.getBytes("utf-8"));
