...
public class FilterUtil {
    ...
    static {
        calWayMap.put(Constants.RuleLimitType.EQUAL, new CalWay() {
            @Override
            public int calMeet(Object matterValue, RuleNodeComposite composite) {
                return matterValue.equals(composite.getLimitVal()) ? 0 : 1;
            }
        });
        calWayMap.put(Constants.RuleLimitType.LT, new CalWay() {
            @Override
            public int calMeet(Object matterValue, RuleNodeComposite composite) {
                return Double.parseDouble(matterValue.toString()) < Double.parseDouble(composite.getLimitVal().toString()) ? 0 : 1;
            }
        });
        calWayMap.put(Constants.RuleLimitType.GE, new CalWay() {
            @Override
            public int calMeet(Object matterValue, RuleNodeComposite composite) {
                return Double.parseDouble(matterValue.toString()) >= Double.parseDouble(composite.getLimitVal().toString()) ? 0 : 1;
            }
        });
        calWayMap.put(Constants.RuleLimitType.GT, new CalWay() {
            @Override
            public int calMeet(Object matterValue, RuleNodeComposite composite) {
                return Double.parseDouble(matterValue.toString()) > Double.parseDouble(composite.getLimitVal().toString()) ? 0 : 1;
            }
        });
        calWayMap.put(Constants.RuleLimitType.LE, new CalWay() {
            @Override
            public int calMeet(Object matterValue, RuleNodeComposite composite) {
                return Double.parseDouble(matterValue.toString()) <= Double.parseDouble(composite.getLimitVal().toString()) ? 0 : 1;
            }
        });
        calWayMap.put(Constants.RuleLimitType.ENUM, new CalWay() {
            @Override
            public int calMeet(Object matterValue, RuleNodeComposite composite) {
                return calEnum(matterValue,composite);
            }
        });
        calWayMap.put(Constants.RuleLimitType.LEG, new CalWay() {
            @Override
            public int calMeet(Object matterValue, RuleNodeComposite composite) {
                return calLEG(matterValue,composite);
            }
        });
        calWayMap.put(Constants.RuleLimitType.SEG, new CalWay() {
            @Override
            public int calMeet(Object matterValue, RuleNodeComposite composite) {
